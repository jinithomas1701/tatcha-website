 ...
 /**
    ...
    SmartOrderRefill.ModalOptions = {
        ...
        addProductPDPOptions: {
            autoOpen: true,
            bgiframe: true,
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_ADD_PRODUCT_TITLE : ''),
            modal: true,
            emptyOnClose: false,
            width: "25rem",
            buttons: {
        ...
        reactivateSubscriptionOptions: {
            autoOpen: true,
            bgiframe: true,
            title: (SmartOrderRefillSettings.Resources ? SmartOrderRefillSettings.Resources.SOR_REACTIVE_SUBSCRIPTION_TITLE : ''),
            modal: true,
            emptyOnClose: false,
            width: "25rem",
            buttons: {
        ...
        reactivateOrderViewOptions: {
            autoOpen: true,
            bgiframe: true,
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_REACTIVE_ORDER_TITLE : ''),
            modal: true,
            emptyOnClose: false,
            width: "25rem",
            buttons: {
        ...
        updateCreditCardFormOptions: {
            autoOpen: true,
            bgiframe: true,
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_UPDATE_CREDIT_CARD_TITLE : ''),
            modal: true,
            emptyOnClose: false,
            width: "37.5rem",
            buttons: {
        ...
        subscriptionViewOptions: {
            ...
            width: "43.75rem",
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_DIALOG_SUBSCRIPTION : ''),
            buttons: {
        ...
        orderViewOptions: {
            ...
            modal: true,
            width: "43.75rem",
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_DIALOG_ORDER : ''),
            buttons: {
                SOR_GLOBAL_CLOSE: SmartOrderRefill.closeModal
            }
        },
        modifyRefillOptions: {
            ...
            dialogClass: "smart-order-refill-modal",
            modal: true,
            title: (SmartOrderRefillSettings.Resources? SmartOrderRefillSettings.Resources.SOR_MODIFY_SMART_ORDER_REFILL : ''),
            width: "37.5rem",
            buttons: {
