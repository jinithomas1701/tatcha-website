...
var hanldeUpdateOrder = require('int_afterpay_core/cartridge/scripts/checkout/afterpayUpdateOrder.js').HanldeUpdateOrder;
var BaseUpdateOrderService = require('*/cartridge/scripts/logic/services/afterpayUpdateOrderService.js');
var sitePreferencesUtilities = require('int_afterpay_core/cartridge/scripts/util/afterpayUtilities.js').getSitePreferencesUtilities();
