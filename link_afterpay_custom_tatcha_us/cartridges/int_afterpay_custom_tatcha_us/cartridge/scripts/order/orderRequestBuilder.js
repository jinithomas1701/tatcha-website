...
(function () {
    ...
    var Builder = require('int_afterpay_core/cartridge/scripts/util/builder');
    var Order = require('int_afterpay_core/cartridge/scripts/order/order').Order;
    var LineItem = require('int_afterpay_core/cartridge/scripts/order/order').LineItem;
    var Discount = require('int_afterpay_core/cartridge/scripts/order/order').Discount;
    var AfterpayWebServiceUtilities = require('int_afterpay_core/cartridge/scripts/util/afterpayUtilities').getSitePreferencesUtilities();
    var PAYMENT_MODE = require('int_afterpay_core/cartridge/scripts/util/afterpayConstants').PAYMENT_MODE;
