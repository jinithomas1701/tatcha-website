...
var braintreePaypalProcessor = require('~/cartridge/scripts/braintree/processorPaypal');
...
function Handle(args, fromCart) {
    var result = braintreePaypalProcessor.handle(args.Basket, fromCart);
    return result;
}
...
function Authorize(args) {
    var result = braintreePaypalProcessor.authorize(args.OrderNo, args.PaymentInstrument);
    return result;
}
