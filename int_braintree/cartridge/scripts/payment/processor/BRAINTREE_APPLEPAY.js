...
var braintreeApplepayProcessor = require('~/cartridge/scripts/braintree/processorApplepay');
...
function Handle(args, fromCart) {
    var result = braintreeApplepayProcessor.handle(args.Basket, fromCart);
    return result;
}
...
function Authorize(args) {
    var result = braintreeApplepayProcessor.authorize(args.OrderNo, args.PaymentInstrument);
    return result;
}
