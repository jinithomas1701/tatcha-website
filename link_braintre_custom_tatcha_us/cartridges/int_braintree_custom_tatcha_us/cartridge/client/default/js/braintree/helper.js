...
function setDefaultProperty(params) {
    return $.get(params.url + '?UUID=' + params.id + '&pmID=' + params.paymentMethodID)
            .then((data) => {
                location.reload();
                // var newDefaultCard = document.querySelector('#uuid-' + data.newDefaultProperty).parentElement.innerHTML;
                // var oldDefaultCard = document.querySelector('#uuid-' + data.toRemoveDefaultProperty).parentElement.innerHTML;
                // document.querySelector('#uuid-' + data.newDefaultProperty).parentElement.innerHTML = oldDefaultCard;
