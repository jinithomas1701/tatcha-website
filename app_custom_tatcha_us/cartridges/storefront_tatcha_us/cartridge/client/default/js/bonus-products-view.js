...
function createOrder() {
	...
	var $paymentMethods = $form.find('input[name$="_selectedPaymentMethodID"]'); var $btnContinue = $form.find('button[name$="_billing_save"]');

	$btnContinue.on('click', function(e) {

	if ($paymentMethods.filter(':checked').val() === 'AFTERPAY_PBI') { e.preventDefault();
