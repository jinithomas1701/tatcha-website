...
var regex = {
    ...
    emptyPassword: /^\s*$/,
    userName: /^[a-zA-Z.\s]+$/,
    newPassword: /^(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9!@#$%^&*]{8,255}$/
};
...
$.validator.addMethod('password_new', function (value) {
	var isValid = regex.newPassword.test($.trim(value));
    return isValid;
}, Resources.VALIDATE_MINLENGTH);
