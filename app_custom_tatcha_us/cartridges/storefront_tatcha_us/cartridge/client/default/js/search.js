...
var productTile = require('./product-tile'),
    ...
    wishlist = require('./components/wishlist'),
...
function updateProductListing(url,device) {
    ...
    $('.category-page.product-list-v2').load(util.appendParamToURL(url, 'format', 'ajax'), function () {
        //compareWidget.init();
        productTile.init();
...
function initializeEvents() {
    ...
    $(document).on('click', '.refinement a, .pagination a, .breadcrumb-refinement-value a', function (e) {
