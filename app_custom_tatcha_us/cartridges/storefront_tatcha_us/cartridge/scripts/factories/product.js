...
var productPairsWith = require('*/cartridge/models/product/productPairsWith');
...
module.exports = {
    get: function (params) {
        ...
        switch (params.pview) {
            case 'tile':
            	if (params.updateTile && productType != 'variationGroup') {
					var variationsProduct = productHelper.getVariationModel(apiProduct, params.variables);
            ...
            case 'bonus':
                ...
                break;
            case 'pairsWith':
                product = productPairsWith(product, apiProduct, productType);
                break;
            default: // PDP
                options = productHelper.getConfig(apiProduct, params);
