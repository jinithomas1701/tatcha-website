 ...
 $('.dismiss-homescreen-banner').click( function() {
   $('.homescreen-banner').hide();
    ...
    $('#qm','#qm-md').focusin(function(e) {
	  ...
	  if($('#navigation .dropdown-mainmenu').css('visibility') === 'visible'){
		  $('#navigation .dropdown-mainmenu').find('.dropdown-submenu .dropdown-menu').css('visibility', 'hidden');
		  $('#navigation .dropdown-mainmenu').css('visibility', 'hidden');
	  }
	...
	**/
	...
	// iframe height setting on order history details page
	// document.getElementsByClassName("container myaccount-order-details")[0].querySelector('iframe').height='350px';
