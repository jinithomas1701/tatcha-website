...
var createAfterpaySitePreferencesUtilities = Class.extend({
    ...
    getExpressServiceName: function () {
        return Site.current.preferences.custom.apExpressServiceName;
    },

    isAfterpayExpressEnabled: function () {
        return Site.current.preferences.custom.apExpressEnabled;
    }
});
