...
5. Use the sendEmail() method in int_klaviyo_services/cartridge/scripts/utils/klaviyo/KlaviyoUtils.js to send a track event. The parameters include the email, payload and event type. 