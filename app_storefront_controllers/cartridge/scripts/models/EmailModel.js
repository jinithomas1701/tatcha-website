...
var EmailModel = AbstractModel.extend({
    ...
    init: function (template, recipient) {
        ...
        mail.setFrom(Site.getCurrent().getCustomPreferenceValue('customerServiceEmail') || 'no-reply@tatcha.com');
    },
...
EmailModel.sendMail = function (options) {
    ...
    mail.setFrom(options.from || Site.getCurrent().getCustomPreferenceValue('customerServiceEmail') || 'no-reply@tatcha.com');
